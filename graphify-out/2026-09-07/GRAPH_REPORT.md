...
## Corpus Check
- 106 files · ~37,674 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 705 nodes · 1029 edges · 71 communities (51 shown, 17 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `336ad64d`
...
Cohesion: 0.11
Nodes (10): Optional, @angular/forms, DexieTimeEntryRepository, TimeEntryDB, Injectable, CourseVisit, MonthlyCourseCount, Person (+2 more)
...
Cohesion: 0.09
Nodes (22): name, private, version, @angular/build, @angular/cdk, @angular/cli, angular-cli-ghpages, @angular/common (+14 more)
...
Cohesion: 0.07
Nodes (17): Input, Output, @angular/service-worker, rxjs, ChangeEntry, ChangelogEntry, Injectable, UpdateNotificationService (+9 more)
...
Cohesion: 0.13
Nodes (14): Archivos de spec existentes, Convenciones, Convención de mocks para este proyecto, Data — tests de integración con Dexie real (fake-indexeddb), Domain — tests puros, sin Angular TestBed, Estrategia por capa, Facade — mockear ITimeEntryRepository, Flujo de enforcement (+6 more)
...
Cohesion: 0.06
Nodes (23): BackupReminderFrequency, BackupReminderService, DAYS, Injectable, MODE_CYCLE, ThemeMode, ThemeService, Injectable (+15 more)
...
### Community 50 - "TimeEntryFacade"
Cohesion: 0.16
Nodes (4): ITimeEntryRepository, TimeEntryFacade, Inject, Injectable

### Community 51 - "time-entry.usecase.ts"
Cohesion: 0.18
...
### Community 52 - "TimeEntryFormComponent"
Cohesion: 0.24
Nodes (4): TimeEntryFormComponent, Component, Input, Output

### Community 53 - "time-entry.facade.ts"
Cohesion: 0.11
Nodes (15): @ngx-translate/core, TimeEntryType, CalendarDay, today, TimeEntryDayComponent, Component, Input, Output (+7 more)
...
Cohesion: 0.22
Nodes (3): Component, DurationWheelPickerStub, MatSelectStub
...
## Knowledge Gaps
- **261 isolated node(s):** `check-coverage.sh script`, `$schema`, `version`, `newProjectRoot`, `projectType` (+256 more)
...
- **Why does `@angular/core` connect `time-entry.module.ts` to `package.json`, `UpdateBannerComponent`, `app-module.ts`, `BackupReminderService`, `time-entry.facade.ts`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `@ngx-translate/core` connect `time-entry.facade.ts` to `CourseVisit`, `time-entry.module.ts`, `package.json`, `UpdateBannerComponent`, `app-module.ts`, `BackupReminderService`, `App`?**
...
- **What connects `check-coverage.sh script`, `$schema`, `version` to the rest of the system?**
