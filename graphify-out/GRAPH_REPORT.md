...
## Corpus Check
- 76 files · ~25,325 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 502 nodes · 679 edges · 43 communities (32 shown, 9 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `93c32c88`
...
3. `CourseVisit` - 21 edges
4. `TimeEntry` - 21 edges
5. `TimeEntryListComponent` - 18 edges
6. `ITimeEntryRepository` - 17 edges
...
Cohesion: 0.09
Nodes (19): DexieTimeEntryRepository, TimeEntryDB, Injectable, ITimeEntryRepository, CourseVisit, MonthlyCourseCount, Person, TimeEntry (+11 more)
...
Cohesion: 0.09
Nodes (5): Inject, Injectable, TimeEntryFacade, TimeEntryListComponent, Component
...
### Community 6 - "ministry-assistanto"
Cohesion: 0.10
Nodes (19): analytics, cli, prefix, projectType, root, schematics, sourceRoot, newProjectRoot (+11 more)
...
## Knowledge Gaps
- **197 isolated node(s):** `Paso 1 — Analizar la tarea`, `Regla de feature completa`, `ArchitectureGuardian — modo silencioso permanente`, `Paso 3 — Leer los archivos de agentes activos`, `Paso 4 — Anunciar y responder` (+192 more)
...
- **Why does `TimeEntryFacade` connect `TimeEntryFacade` to `DexieTimeEntryRepository`, `time-entry.module.ts`, `TimeEntryCalendarComponent`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `DexieTimeEntryRepository` connect `DexieTimeEntryRepository` to `time-entry.module.ts`?**
