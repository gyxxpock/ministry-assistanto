...
## Corpus Check
- 67 files · ~21,529 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 416 nodes · 596 edges · 32 communities (23 shown, 8 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 25 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7c67f6c0`
...
10. `TimeEntryCalendarComponent` - 12 edges
...
Cohesion: 0.09
Nodes (16): DexieTimeEntryRepository, TimeEntryDB, Injectable, CourseVisit, MonthlyCourseCount, Person, TimeEntry, computeMonthlyTotals() (+8 more)
...
### Community 11 - "TimeEntryFormComponent"
Cohesion: 0.22
...
## Knowledge Gaps
- **141 isolated node(s):** `graphify`, `Usage`, `What graphify is for`, `Step 0 - GitHub repos and multi-path merge (only if a URL or several paths)`, `Step 1 - Ensure graphify is installed` (+136 more)
