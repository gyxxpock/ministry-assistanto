...
## Corpus Check
- 144 files · ~48,444 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 846 nodes · 1414 edges · 72 communities (53 shown, 15 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 26 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d3360e0a`
...
- `DialogData` --references--> `Goal`  [EXTRACTED]
  src/app/goals/presentation/components/goal-config/goal-config.component.ts → src/app/goals/domain/models.ts
...
### Community 1 - "goals/domain/models.ts"
Cohesion: 0.06
Nodes (35): Optional, DexieGoalRepository, Injectable, ActiveGoalRecord, GoalsDB, buildServiceYearFromYear(), computeAuxiliaryGoalProgress(), computeGoalProgress() (+27 more)
...
Cohesion: 0.18
Nodes (4): @angular/forms, DurationWheelPickerComponent, Component, ViewChild

### Community 7 - "goals.module.ts"
Cohesion: 0.08
Nodes (17): @angular/common, I18nDatePipe, Pipe, GoalProgressVisualComponent, Component, Input, GoalStatusBadgeComponent, Component (+9 more)
...
Cohesion: 0.09
Nodes (16): MODE_CYCLE, ThemeMode, ThemeService, Injectable, SettingsComponent, TranslateStub, Pipe, Component (+8 more)
...
Cohesion: 0.13
Nodes (9): @angular/router, @ngx-translate/core, I18nDateStub, Pipe, MaterialModule, NgModule, routes, TimeEntryModule (+1 more)

### Community 53 - "time-entry.facade.ts"
Cohesion: 0.05
Nodes (31): TimeEntryType, computeMonthlyTotals(), inMonth(), mergeTimeEntry(), MonthlyTotals, normalizeName(), toDateKey(), toKey() (+23 more)

### Community 54 - "@angular/core"
Cohesion: 0.24
Nodes (7): @angular/core, ChangeEntry, ChangelogEntry, Component, Input, Output, UpdateBannerComponent
...
Cohesion: 0.40
Nodes (4): MonthPaginatorComponent, Component, Input, Output

### Community 64 - "TimeEntryCalendarComponent"
Cohesion: 0.19
Nodes (3): TimeEntryCalendarComponent, Component, toDateKey()

### Community 68 - "I18nDateStub"
Cohesion: 0.40
Nodes (3): I18nDateStub, TranslateStub, Pipe

## Knowledge Gaps
- **269 isolated node(s):** `routes`, `ActiveGoalRecord`, `GoalType`, `MonthOption`, `routes` (+264 more)
...
- **Why does `@angular/core` connect `@angular/core` to `CourseVisit`, `goals/domain/models.ts`, `package.json`, `DurationWheelPickerComponent`, `goals.module.ts`, `app-module.ts`, `time-entry-list.component.ts`, `settings.component.ts`, `BackupReminderService`, `time-entry.module.ts`, `time-entry.facade.ts`, `changelog.service.ts`, `MonthPaginatorComponent`?**
  _High betweenness centrality (0.154) - this node is a cross-community bridge._
- **Why does `@ngx-translate/core` connect `time-entry.module.ts` to `CourseVisit`, `goals/domain/models.ts`, `package.json`, `goals.module.ts`, `app-module.ts`, `time-entry-list.component.ts`, `settings.component.ts`, `time-entry.facade.ts`, `@angular/core`, `changelog.service.ts`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `dependencies` connect `dependencies` to `package.json`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **What connects `routes`, `ActiveGoalRecord`, `GoalType` to the rest of the system?**
...
- **Should `goals/domain/models.ts` be split into smaller, more focused modules?**
