...
| `documentation-agent` | Transversal — docs orchestration (docs/index.md, _meta/) | yes |
...
| `compodoc-agent` | `docs/generated/api/**` — dormant until Compodoc is explicitly installed | yes |
