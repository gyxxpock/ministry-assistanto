...
describe('TimeEntryExporter', () => {
  it('generates CSV with entries and visits', () => {
    const entries = [ { id: 'e1', date: new Date('2025-11-01'), durationMinutes: 60, type: 'preaching' } ] as any;
    const visits = [ { id: 'v1', date: new Date('2025-11-02'), durationMinutes: 30, personName: 'Ana' } ] as any;
