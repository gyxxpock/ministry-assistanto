...
describe('Integration: Dexie repository + computeMonthlyTotals', () => {
  ...
  it('computes totals from persisted entries and visits', async () => {
    ...
    await repo.addEntry({ id: 'e2', date: new Date('2025-11-10'), durationMinutes: 180, type: 'study' });

    await repo.addVisit({ id: 'v1', date: new Date('2025-11-12'), durationMinutes: 60, personId: 'p1' });
    await repo.addVisit({ id: 'v2', date: new Date('2025-11-13'), durationMinutes: 60, personId: 'p2' });
